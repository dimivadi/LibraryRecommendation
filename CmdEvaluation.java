...
public class CmdEvaluation implements Callable<Integer> {
...
//	private boolean excludeProjects = false;
	...
	public void runEval(String[] args) {
		int exitCode = new CommandLine(new CmdEvaluation()).setCaseInsensitiveEnumValuesAllowed(true).execute(args);
